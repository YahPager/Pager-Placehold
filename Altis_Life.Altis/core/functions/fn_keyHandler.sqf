...
switch (_code) do {
	...
	case 38: {
		...
		if(_shift && playerSide in [west,independent]) then {
			if(vehicle player != player && (typeOf vehicle player) in ["C_Offroad_01_F","C_Hatchback_01_sport_F","C_SUV_01_F","B_G_Offroad_01_F","B_MRAP_01_F","O_MRAP_02_F","C_Offroad_02_unarmed_F"]) then {
